...
def adjust_actions(df_pos, trains, df_actions, tracks):
    ...
    while changed:
        ...
        for train in df_actions['trainID'].unique():
            ...
            # For visualization, remove unnecessary spawn actions or
...
def write_act_err_txt(original, adjusted, trains):
    ...
    with open("data/act_err.txt", 'w') as f, open("data/act_err_min.txt", 'w') as f_min:
        ...
        header = "ACT_ERR Overview\n\n" + \
                 ...
                 "the provided actions failed to guide the train\n" + \
        ...
        f_min_additional_header = "Please note, that wait periods are replaced by \'...\'\n" + \
        ...
        for id in sorted(act_err_trains):
            ...
            for _, row in df_train_actions.iterrows():
                ...
                if prev_t is None:
                    ...
                    for t_miss in range(prev_t, t):
                        missing_t.append(t_miss)
                # Write log
            ...
            if missing_t:
                f.write(f"=== Train {id} - Missing Timesteps: {missing_t}\n\n\n")
                f_min.write(f"=== Train {id} - Missing Timesteps: {missing_t}\n\n\n")
            else:
